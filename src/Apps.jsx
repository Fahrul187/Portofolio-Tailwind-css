            ...
            <header className="place flex justify-between">
                ...
                <div ref={menuRef} className="flex">
                    ...
                    <ul className={`flex tracking-widest text-[15px] gap-4 md:gap-5 items-center flex-col md:flex-row md:opacity-100 absolute md:pointer-events-auto md:static top-17 p-3 md:p-0 right-10 bg-white shadow-lg md:shadow-none rounded-lg md:bg-transparent w-50 md:w-auto md:h-auto ${isOpen ? 'opacity-100 pointer-events-auto translate-y-0 ' : 'opacity-0 pointer-events-none -translate-y-7'} md:translate-0 transition-all duration-300 ease-in-out `}>
                        <li><a onClick={() => setIsOpen(false)} className="text-primary md:relative md:after:content-[''] md:after:absolute md:after:left-1/2 md:after:-bottom-1 md:after:w-0 md:after:h-px md:after:bg-primary md:after:transition-all md:after:duration-700 md:hover:after:left-0 md:hover:after:w-full px-[68px] md:px-0 py-2.5 md:py-0 hover:text-primary transition-all duration-300 " href="#">Beranda</a></li>
                        <li><a onClick={() => setIsOpen(false)} className="md:relative md:after:content-[''] md:after:absolute md:after:left-1/2 md:after:-bottom-1 md:after:w-0 md:after:h-px md:after:bg-primary md:after:transition-all md:after:duration-700 md:hover:after:left-0 md:hover:after:w-full px-[47px] md:px-0 py-2.5 md:py-0 hover:text-primary transition-all duration-300 whitespace-nowrap" href="#about">Tentang Saya</a></li>
                        <li><a onClick={() => setIsOpen(false)} className="md:relative md:after:content-[''] md:after:absolute md:after:left-1/2 md:after:-bottom-1 md:after:w-0 md:after:h-px md:after:bg-primary md:after:transition-all md:after:duration-700 md:hover:after:left-0 md:hover:after:w-full px-[60px] md:px-0 py-2.5 md:py-0 hover:text-primary transition-all duration-300 " href="#portofolio">Portofolio</a></li>
                        <li><a onClick={() => setIsOpen(false)} className="md:relative md:after:content-[''] md:after:absolute md:after:left-1/2 md:after:-bottom-1 md:after:w-0 md:after:h-px md:after:bg-primary md:after:transition-all md:after:duration-700 md:hover:after:left-0 md:hover:after:w-full px-[73px] md:px-0 py-2.5 md:py-0 hover:text-primary transition-all duration-300 " href="#clients">Clients</a></li>
                        <li><a onClick={() => setIsOpen(false)} className="md:relative md:after:content-[''] md:after:absolute md:after:left-1/2 md:after:-bottom-1 md:after:w-0 md:after:h-px md:after:bg-primary md:after:transition-all md:after:duration-700 md:hover:after:left-0 md:hover:after:w-full px-[82px] md:px-0 py-2.5 md:py-0 hover:text-primary transition-all duration-300 " href="#blog">Blog</a></li>
                        <li><a onClick={() => setIsOpen(false)} className="md:relative md:after:content-[''] md:after:absolute md:after:left-1/2 md:after:-bottom-1 md:after:w-0 md:after:h-px md:after:bg-primary md:after:transition-all md:after:duration-700 md:hover:after:left-0 md:hover:after:w-full px-[69px] md:px-0 py-2.5 md:py-0 hover:text-primary transition-all duration-300 " href="#contact">Contact</a></li>
                    </ul>
                </div>
            </header>
        </nav>
        ...
        <section id="about" className="pt-36 place pb-32">
            <div className="">
                <div className="flex flex-col w-44">
                    ...
                    <div className={`h-1 rounded-xl bg-primary transition-all duration-2000 ${isTerlihat ? 'w-full' : 'w-0'}`}></div>
                </div>
                ...
                <div className="w-full justify-center flex mb-10">
                    <div className="max-w-xl flex flex-col justify-center items-center gap-5 text-center">
                        <div>
                            ...
                            <div className={`h-1 w-[105px] rounded-xl mx-auto bg-primary transition-all duration-2000 origin-center ${isTerlihat ? 'scale-x-100' : 'scale-x-0'}`}></div>
                        </div>
                ...
                <div className="w-full">
                    <div className="mx-auto text-center mb-16">
                        <div>
                            ...
                            <div className={`h-1 w-17 rounded-xl mx-auto bg-primary transition-all duration-2000 origin-center ${isTerlihat ? 'scale-x-100' : 'scale-x-0'}`}></div>
                        </div>
            ...
            <div className="place">
                <div className="w-full">
                    <div className="max-w-xl mx-auto text-center mb-16">
                        <div>
                            <h4 ref={line} className="font-semibold mb-0.5 text-lg text-primary md:text-2xl">Blog</h4>
                            <div className={`h-1 w-12 rounded-xl mx-auto bg-primary transition-all duration-2000 origin-center ${isTerlihat ? 'scale-x-100' : 'scale-x-0'}`}></div>
                        </div>
        ...
        <section id="contact" className="place py-36">
            <div className="max-w-xl mx-auto text-center mb-16">
                <div>
                    ...
                    <div className={`h-1 w-21 rounded-xl mx-auto bg-primary transition-all duration-2000 origin-center ${isTerlihat ? 'scale-x-100' : 'scale-x-0'}`}></div>
                </div>
